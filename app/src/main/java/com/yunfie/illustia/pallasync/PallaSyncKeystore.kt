...
class PallaSyncKeystore(context: Context) {
    ...
    fun getRootPrivateKey(): String? {
        return sharedPrefs.getString("root_private_seed", null)
    }
    ...
    fun getDevicePrivateKey(): String? {
        return sharedPrefs.getString("device_private_seed", null)
    }
    ...
    fun getDeviceSignPublicKey(): String? {
        return sharedPrefs.getString("device_sign_public", null)
    }
    ...
    fun getDeviceHpkePrivateKey(): String? {
        return sharedPrefs.getString("device_hpke_private", null)
    }
    ...
    fun getDeviceHpkePublicKey(): String? {
        return sharedPrefs.getString("device_hpke_public", null)
    }
    ...
    fun getDeviceCertificate(): String? {
        return sharedPrefs.getString("device_certificate", null)
    }
    ...
    fun getDeviceId(): String? {
        ...
        if (id == null) {
            id = com.yunfie.illustia.pallasync.util.UuidV7.generateString()
            saveDeviceId(id)
        }
        return id
    }
    ...
    fun getEpochKey(): String? {
        return sharedPrefs.getString("epoch_key", null)
    }
    ...
    fun getPairingPrivateKey(): String? {
        return sharedPrefs.getString("pairing_private_key", null)
    }
    ...
    fun getPendingChainKeys(): PallaSyncKeySnapshot? {
        val chainId = sharedPrefs.getString("pending_chain_id", null)?.takeIf { it.isNotBlank() }
            ?: return null
        return PallaSyncKeySnapshot(
            chainId = chainId,
            seedPhrase = sharedPrefs.getString("pending_seed_phrase", null)
                ?.takeIf { it.isNotBlank() } ?: return null,
            encryptionKeyBase64Url = sharedPrefs.getString("pending_epoch_key", null)
                ?.takeIf { it.isNotBlank() } ?: return null,
            signingKeyBase64Url = sharedPrefs.getString("pending_signing_key", null)
                ?.takeIf { it.isNotBlank() } ?: return null,
            publicKeyBase64Url = sharedPrefs.getString("pending_public_key", null)
                ?.takeIf { it.isNotBlank() } ?: return null,
        )
    }
    ...
    fun getSeedPhrase(): String? {
        return sharedPrefs.getString("seed_phrase", null)
    }
}
