...
internal suspend fun PalleriaSyncCoordinator.enqueueSettingsChanges(
    previous: AppSettings,
    next: AppSettings,
) {
...
internal suspend fun PalleriaSyncCoordinator.enqueueInitialSettings(settings: AppSettings) {
